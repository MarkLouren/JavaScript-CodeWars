/* CAT: https://www.codewars.com/kata/58b972cae826b960a300003e
...
function missingWord(nums, str) {
  ...
  var newar=(str.split(" ")).join("");
  var phrase =newar.charAt(sorted[0])+newar.charAt(sorted[1])+newar.charAt(sorted[2]);
    
    if (phrase.length==3){ return (phrase.toLowerCase());
                         } else {
